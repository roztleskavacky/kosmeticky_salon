                     ...
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="btn-toolbar">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-primary">Přehled rezervací</button>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" data-toggle="dropdown" class="btn btn-warning dropdown-toggle btn-sm myBtnTime">9:00 - 10:00 <span class="caret"></span></button>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" data-toggle="dropdown" class="btn btn-warning dropdown-toggle btn-sm myBtnTime">12:00 - 12:30 <span class="caret"></span></button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="#">Zelená</a></li>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" data-toggle="dropdown" class="btn btn-warning dropdown-toggle btn-sm myBtnTime">13:00 - 15:00 <span class="caret"></span></button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="#">Nová</a></li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" data-toggle="dropdown" class="btn btn-warning dropdown-toggle btn-sm myBtnTime">12:30 - 13:00 <span class="caret"></span></button>
                                                <ul class="dropdown-menu">
                                                    <li><a href="#">Zelená</a></li>
